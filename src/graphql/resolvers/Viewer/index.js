    ...
    Mutation: {
        ...
        connectStripe: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const wallet = yield api_1.StripeApi.connect(code);
                if (!wallet) {
                ...
                throw new Error(`Failed to connect with Stripe. Error: ${error}`);
            }
        }),
        disconnectStripe: (_root, _args, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                throw new Error(`Failed to disconnect with Stripe. Error: ${error}`);
            }
        }),
    },
    Viewer: {
